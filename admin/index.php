...
<head>
	...
	<link rel='shortcut icon' href='<?= $homeurl ?>/favicon2.ico' />
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						...
						<?php endif ?>
						<li class='treeview'><a href='?pg=siswa'><i class="fas fa-user-friends side-menu-icon fa-fw   "></i> <span>Data Siswa</span></a></li>
						<li class='treeview'>
						...
						<div class='row'>
							...
							<div class="col-md-4">
								<div class="box box-solid">
									...
									<div class="box-body">
										<div id='infoweb'></div>
										<p><b>POSKO CBT SMK BAKTI</b></p>

										<ul class="list-group">
											<li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
												<a href="http://103.31.251.102/landing" target="_blank" class="btn btn-success">
													<i class="fas fa-globe    "></i> Landing Page
												</a></li>
											<li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
												<a href="" target="_blank" class="btn btn-primary">
													<i class="fab fa-telegram-plane"></i> Chat Admin
												</a></li>
											<li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
		...
		<footer class='main-footer hidden-xs'>
			<div class='container'>
				<div class='pull-left hidden-xs'>
					<strong>
						<span id='end-sidebar'>
							&copy; 2022 <?= APLIKASI . " v" . VERSI . " r" . REVISI ?>
						</span>
					</strong>
				</div>
